...
public class UsuarioService {
	private List<Usuario> usuarios = DatabaseHelper.getInstance().getUsuarios();
	
	public UsuarioService(){
		if (usuarios == null || usuarios.isEmpty()){
			DatabaseHelper.getInstance().getUsuariosDB();
			usuarios = DatabaseHelper.getInstance().getUsuarios();
		}
	}
